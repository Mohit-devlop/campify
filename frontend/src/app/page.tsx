        ...
        <div className="p-5 bg-brand-card border border-white/5 rounded-[24px] shadow-lg flex flex-col md:flex-row items-center justify-between gap-5 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <div className="flex flex-col">
              <h2 className="text-sm font-black text-white leading-tight">Welcome, {user.name || user.username}! 🚀</h2>
              <p className="text-[10px] text-neutral-500 mt-0.5">Let&apos;s build some awesome projects today.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 flex-wrap md:flex-nowrap w-full md:w-auto justify-between md:justify-end">
            ...
            <div className="flex items-center gap-2 p-2.5 bg-black/40 border border-white/5 rounded-xl w-[95px] flex-shrink-0">
              <span className="text-sm">⚡</span>
              <div className="flex flex-col">
                <span className="text-[8px] uppercase font-bold text-neutral-500">Activity</span>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="flex-1 flex flex-col gap-2">
              <textarea
                ...
                rows={2}
                className="w-full bg-transparent border-0 outline-none text-sm placeholder:text-neutral-650 resize-none focus:ring-0 text-white"
              />
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col gap-3 text-white">
                    ...
                    {/* Likes Count */}
                    <span className="font-bold text-xs text-neutral-350">
                    ...
                    {post.content && (
                      <p className="text-xs text-neutral-300 leading-relaxed">
                        <Link href={`/${post.user.username}`} className="font-bold mr-2 text-white hover:underline no-underline">
                          {post.user.username}
                        </Link>
                        {post.content}
                      </p>
                              ...
                              commentsMap[post.id].map((comment: any) => (
                                <div key={comment.id} className="flex gap-3 items-start text-xs">
                                  ...
                                  <div className="flex flex-col flex-1">
                                    ...
                                    <span className="text-neutral-300 mt-0.5 leading-relaxed">{comment.content}</span>
                                  </div>
                                </div>
                              ))
                            )}
            ...
            {suggestions.slice(0, 3).map((creator) => {
              ...
              return (
                <div key={creator.id} className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-[9px] font-semibold text-neutral-500">{isOnline ? 'Active Now' : 'Offline'}</span>
                </div>
              );
            })}
          </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] text-neutral-500">142 members</span>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] text-neutral-500 font-medium">96 members</span>
                </div>
              </div>
              <button className="text-[9px] font-bold text-brand-cyan bg-brand-cyan/5 border border-brand-cyan/20 px-2.5 py-1 rounded-lg hover:bg-brand-cyan hover:text-black transition-colors cursor-pointer">Join</button>
            </div>
          ...
          <div className="flex flex-col gap-3.5 text-xs">
            <div className="flex gap-3 items-start">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-neutral-500 mt-0.5">24h innovation build sprint</span>
              </div>
            </div>
            <div className="flex gap-3 items-start">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-neutral-500 mt-0.5">Incubator pitch day</span>
              </div>
            </div>
          </div>
        </div>
