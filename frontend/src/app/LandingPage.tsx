  ...
  return (
    <div className="min-h-screen w-full bg-brand-bg text-brand-text transition-colors duration-300 relative overflow-hidden select-none font-sans pb-16">
        ...
        <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <motion.button
              ...
              onClick={toggleTheme}
              type="button"
              className="w-10 h-10 rounded-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/5 text-neutral-600 dark:text-neutral-450 hover:text-brand-orange hover:border-brand-orange/20 dark:hover:text-brand-orange flex items-center justify-center cursor-pointer transition-all shadow-sm"
            ...
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
              <Link 
                ...
                className="bg-neutral-900 dark:bg-white text-white dark:text-neutral-950 font-extrabold text-xs px-4 py-2.5 rounded-xl hover:opacity-90 transition-opacity no-underline block shadow-md"
              >
                Get Started
              </Link>
            </motion.div>
      ...
      >
        ...
        <motion.p 
          variants={itemVariants}
          className="text-neutral-600 dark:text-neutral-450 text-sm md:text-base leading-relaxed max-w-2xl"
        >
        ...
        >
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Link 
              href="/auth?tab=register" 
              className="bg-gradient-to-r from-brand-orange to-brand-cyan hover:opacity-95 text-black font-black text-sm px-8 py-3.5 rounded-2xl flex items-center gap-2 shadow-lg shadow-brand-orange/10 transition-all border-0"
            >
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Link 
              href="/auth?tab=login" 
              className="bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-850/80 text-neutral-800 dark:text-neutral-200 border border-neutral-200 dark:border-white/5 font-bold text-sm px-8 py-3.5 rounded-2xl transition-all shadow-sm"
            >
              Sign In to Portal
            </Link>
          </motion.div>
        ...
        <motion.div 
          ...
          className="w-full max-w-[850px] mt-8 p-4 md:p-6 rounded-[32px] bg-white/70 dark:bg-brand-card/50 border border-neutral-200/50 dark:border-white/5 backdrop-blur-xl shadow-2xl relative"
        >
      ...
      <section className="max-w-[1200px] mx-auto px-6 pt-24 md:pt-32 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            whileHover={{ y: -8, scale: 1.015, boxShadow: '0 20px 30px -10px rgba(255, 107, 53, 0.08)' }}
          ...
          <motion.div 
            variants={cardVariants}
            whileHover={{ y: -8, scale: 1.015, boxShadow: '0 20px 30px -10px rgba(0, 194, 255, 0.08)' }}
            className="p-6 rounded-[24px] bg-white dark:bg-brand-card border border-neutral-200 dark:border-white/5 shadow-sm flex flex-col gap-4 transition-all duration-300"
          >
          ...
          <motion.div 
            variants={cardVariants}
            whileHover={{ y: -8, scale: 1.015, boxShadow: '0 20px 30px -10px rgba(139, 92, 246, 0.08)' }}
            className="p-6 rounded-[24px] bg-white dark:bg-brand-card border border-neutral-200 dark:border-white/5 shadow-sm flex flex-col gap-4 transition-all duration-300"
          >
          ...
          <motion.div 
            variants={cardVariants}
            whileHover={{ y: -8, scale: 1.015, boxShadow: '0 20px 30px -10px rgba(234, 179, 8, 0.08)' }}
            className="p-6 rounded-[24px] bg-white dark:bg-brand-card border border-neutral-200 dark:border-white/5 shadow-sm flex flex-col gap-4 transition-all duration-300"
          >
          ...
          <motion.div 
            variants={cardVariants}
            whileHover={{ y: -8, scale: 1.015, boxShadow: '0 20px 30px -10px rgba(16, 185, 129, 0.08)' }}
            className="p-6 rounded-[24px] bg-white dark:bg-brand-card border border-neutral-200 dark:border-white/5 shadow-sm flex flex-col gap-4 transition-all duration-300"
          >
      ...
      <motion.footer 
        ...
        className="max-w-[1200px] mx-auto px-6 pt-24 mt-8 border-t border-neutral-200/50 dark:border-white/5 text-neutral-400 dark:text-neutral-500 text-xs flex flex-wrap gap-6 items-center justify-between relative z-10 transition-colors duration-300"
      >
