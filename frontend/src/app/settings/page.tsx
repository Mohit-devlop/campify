      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4 p-4 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <Camera className="w-4 h-4 text-brand-orange animate-pulse" />
                Upload New Photo
              </label>
        ...
        <label className="flex items-center gap-2.5 cursor-pointer select-none py-1.5 px-1 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl">
          ...
          <input
            ...
            className="rounded border-brand-cyan/20 text-brand-orange focus:ring-brand-orange/20 animate-pulse"
          />
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mt-1">
            <div className="flex flex-col gap-0.5">
              <span className="text-xs text-neutral-600 dark:text-neutral-300 font-semibold flex items-center gap-2">
                <MessageSquare className="w-4 h-4 text-brand-cyan animate-pulse" /> Auto-Delete Chat History
              </span>
            ...
            <select
              ...
              className="bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-800 dark:text-neutral-200 text-xs rounded-xl px-3 py-2 cursor-pointer outline-none focus:border-brand-cyan"
            >
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full mt-4 btn-primary-gradient text-black font-extrabold text-xs py-3 rounded-[12px] flex items-center justify-center gap-2 shadow-lg active-shrink hover-scale disabled:opacity-50 border-0 cursor-pointer"
        >
          {isLoading ? (
            <>
