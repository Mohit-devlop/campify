...
<p className="text-xs text-slate-500 dark:text-neutral-400">Enter verification code to configure your campus session.</p>
</div>
)}
{activeTab === 'forgot' && (
<div className="flex flex-col gap-1 text-center">
<h2 className="text-xl font-bold font-outfit text-slate-800 dark:text-white">Account Recovery Key</h2>
<p className="text-xs text-slate-500 dark:text-neutral-400">Enter your email to generate a local password link.</p>
</div>
)}
{activeTab === 'reset' && (
<div className="flex flex-col gap-1 text-center">
<h2 className="text-xl font-bold font-outfit text-slate-800 dark:text-white">Set New Password</h2>
<p className="text-xs text-slate-500 dark:text-neutral-400 font-medium">Please construct a secure password key.</p>
</div>
)}
...
<label className="text-[10px] font-bold text-slate-500 dark:text-neutral-400 uppercase tracking-wider px-1">Email / Username</label>
...
<div className="flex flex-col gap-1.5">
<label className="text-[10px] font-bold text-slate-500 dark:text-neutral-400 uppercase tracking-wider px-1">Verification Code</label>
<input
type="text"
required
maxLength={6}
...
className="w-full bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/5 focus:border-brand-cyan/40 focus:ring-1 focus:ring-brand-cyan/20 rounded-2xl py-3.5 text-center text-xl font-bold tracking-widest outline-none text-slate-800 dark:text-white transition-all focus:bg-white dark:focus:bg-black/60"
/>
</div>
<button
type="button"
